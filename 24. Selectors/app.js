...
// querySelector: CSS kodları tanımlarken "#", "." gibi seçme yöntemlerini kullanırı. querySelector spesifik olarak bir tanesi üzerinde değişim yapmaya izin verir
// querySelectorAll: CSS kodları tanımlarken "#", "." gibi seçme yöntemlerini kullanırı. querySelectorAll birden fazla yerde kullanılan aynı classı, etikeleri hepsini aynı anda görüp, seçip değişim yapmaya izin verir
